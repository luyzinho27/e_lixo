...
<?php
session_start();
//include './cadastrar_login_comum.php';
...
<html lang="en">
    ...
    <body>
        ...
        <div class="fundo">
            <!-- container -->
            <div class="container" id="cont" style="margin-bottom: 9%;">
                ...
                <div style="margin-top: 1.5%" class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                            <div class="panel panel-default">
                                <div style="background: #F7F5F4" class="panel-body">
                                    <h3 style="margin-top: 0%;" class="thin text-center"><strong>Cadastro Participante</strong></h3>
                                    ...
                                    ?>
                                    <form id="login_user_comum" method="post" action="cadastro.php">                                      
                                        <input type="hidden" name="id_usuarios">
                                        <input class="form-control" type="hidden" name="perfil" value="0">
                                        <input class="form-control" type="hidden" name="status" value="ativo">
                                        ...
                                        <div class="row top-margin" style="margin-top: 1%;margin-bottom: 3%">
                                            <div style="margin-top: .5%;margin-bottom: 0%" class="top-margin col-sm-6">
                                                ...
                                                <input type="email" name="email" maxlength="60" class="form-control" value="<?php echo $email; ?>" required placeholder="Ex: exemplo@exemplo.com">
                                            </div>
                                            <div style="margin-top: .5%;margin-bottom: 0%" class="top-margin col-sm-6">
                                                <label>Usuário</label>
                                        ...
                                        <div class="row">
                                            <div style="margin-top: 1.5%;margin-bottom: 1.5%" class="col-lg-4 text-right ">
                                                <button class="btn btn-success " name="cadastrar_login_comum" type="submit">Cadastrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <article style="margin-top: -1.5%" class="col-xs-12 maincontent">
                        <div style="margin-top: 0%"  class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                            <div style="margin-top: 0%" class="row">
                                <div class="col-lg-12" >
                                    <p style="text-align: center;font-size: 1em">Usuário, <b><a href="cadastro_servidor.php">Clique aqui</a></b> e acesse o ambiente destinado ao Cadastro de Servidor.</p>
                                </div>
                            </div>
                        </div>
                    </article>
            ...
            <footer  style="margin-top: 1.5%" id="footer" class="top-space">
